...
\captionof{figure}{Smartphonenutzer in Deutschland \cite{picture:smarphone-user}}
...
\captionof{figure}{Anteil d. Android-Versionen \cite{picture:android-vers}}
\end{center}
...
\captionof{figure}{Code zur Anzeige von Cryptoverfahren \cite{picture:cryptoprovider}}
\end{center}
...
\captionof{figure}{AES State-Block \citep[S. 100]{book:understanding-crypto}}
\hfill
...
\captionof{figure}{AES ShiftRow StateMatrix \citep[S. 104]{book:understanding-crypto}}
\hfill
...
\captionof{figure}{AES MixColumns \citep[S. 105]{book:understanding-crypto}}
\hfill
...
\captionof{figure}{AES Rundenschlüssel \citep[S. 107]{book:understanding-crypto}}
\hfill
...
\captionof{figure}{Aufbau Blowfish \cite[S. 389]{book:angewandte-krypto}}
\end{minipage}
\hfill
...
\captionof{figure}{Funktion Blowfish \cite[S. 390]{book:angewandte-krypto}} 
...
Das hier gezeigte Verfahren zum Erstellen der Teilschlüssel wird auch Schlüsselexpansion genannt, da der Algorithmus nun auf insgesamt 4168 Bit Teilschlüsseln besteht. \citep[S. 390f]{book:angewandte-krypto}
...
Nachdem die oben beschriebene Berechnung für alle 64 Runden durchgeführt wurde, werden die entsprechenden Werte (a-h) miteinander konkateniert und ergeben somit den Hash-Wert \citep[S. 89f]{book:practical-crypto}.
...
\section{Ergebnisse}
In der Nachfolgenden Tabelle werden alle Verfahren mit Punkten von 1-10, wobei 10 das beste und 1 das schlechteste Ergebnis liefert, versehen und mit dessen Gewichtung multipliziert. Die Verteilung der Werte erfolgt durch die Ergebnisse, welche bei der Messung durchgeführt wurden, dabei werden die Punkte 10 und 9 jeweils nur einmal vergeben und die Punkte 8 - 1 jeweils 3 mal. Exemplarisch ist diese Vorgehensweise in nachfolgender Grafik abgebildete. Alle Rohdaten befinden sich im Anhang. 
...
\captionof{figure}{Aufbau GCM \cite{website:androidhive-gcm}}
...
Als letztes möchte ich allen Freunden danken, die mich während des Studiums und auch während der Arbeit begleiteten und ich freue mich auf noch viele lustige, unterhaltsame und tolle Tage und Abende.
...
\pagenumbering{Roman} 
\includepdf[pages=-]{anderes/crypto_2_3_3.pdf}

\chapter{Anhang: Kryptoverfahren Android Version 4.1.1}
\includepdf[pages=-]{anderes/crypto_4_1_1.pdf}

\chapter{Anhang: Kryptoverfahren Android Version 4.4.2}
\includepdf[pages=-]{anderes/crypto_4_4_2.pdf}

\chapter{Anhang: Kryptoverfahren Android Version 5.0.0}
\includepdf[pages=-]{anderes/crypto_5_0_0.pdf}

\chapter{Anhang: Rohdaten Validierung}
\includepdf[pages=-]{anderes/LogFile_CBC.pdf}
\includepdf[pages=-]{anderes/LogFile_CFB.pdf}
\includepdf[pages=-]{anderes/LogFile_CTR.pdf}
\includepdf[pages=-]{anderes/LogFile_OFB.pdf}
\includepdf[pages=-]{anderes/LogFile_Blowfish_CBC.pdf}
\includepdf[pages=-]{anderes/LogFile_Blowfish_CFB.pdf}
\includepdf[pages=-]{anderes/LogFile_Blowfish_CTR.pdf}
\includepdf[pages=-]{anderes/LogFile_Blowfish_OFB.pdf}
