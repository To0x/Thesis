...
\section{Zusammenfassung}
% TODO Prototyp erfolgreich entwickelt!
...
% In späteren Version könnte darüber nachgedacht werden, ob eine Ablauffrist für Schlüssel eingeführt werden soll, oder eine Hierarchie die das Verbreiten von Dateien erlaubt oder diese einschränkt.


\subsection{GCM}
% Google Cloud Messaging als Austausch von Daten
% muss eigner Server implementiert werden!


\subsection{Password-Reset}
% Passwort vergessen, Daten futsch!
% registieren per e-mail, passwort-Reset möglich? aber wie? ... 


\subsection{Schlüsselaustausch}
% andere Methoden wie PGP-Server, oder ähnliches.
